...
class ProfileNotificationOvulation extends StatefulWidget {
  @override
  _ProfileNotificationOvulation createState() => _ProfileNotificationOvulation();
}

class _ProfileNotificationOvulation extends State<ProfileNotificationOvulation> {
  ...
  Widget _buildReminderFields() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('How many days before:', style: TextStyle(fontSize: 16)),
          TextField(
